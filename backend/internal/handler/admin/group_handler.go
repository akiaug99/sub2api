...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok deepseek qwen zhipu moonshot minimax baidu spark hunyuan doubao yi baichuan stepfun sensetime"`
