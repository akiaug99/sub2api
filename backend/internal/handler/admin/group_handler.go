...
type CreateGroupRequest struct {
	...
	Platform         string             `json:"platform" binding:"omitempty,oneof=anthropic openai gemini antigravity grok deepseek qwen zhipu moonshot minimax baidu spark hunyuan doubao yi baichuan stepfun sensetime composite"`
...
type CompositeRouteRequest struct {
	...
	TargetPlatform string `json:"target_platform" binding:"required,oneof=anthropic openai gemini antigravity grok deepseek qwen zhipu moonshot minimax baidu spark hunyuan doubao yi baichuan stepfun sensetime"`
