...
import { getPlatformLabel, type GroupPlatformId } from '@/constants/platforms'

export type Platform = GroupPlatformId
type KnownPlatform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'grok' | 'composite'
